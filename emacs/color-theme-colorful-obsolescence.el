...
;; Pleasure-to-read color (light blue)
     ...
     (mpg123-face-indicator ((t (:inherit font-lock-comment-face))))
     (mpg123-face-slider ((t (:inherit mpg123-face-indicator :weight bold))))
...
;; Strong text highlight 2 (light green)
     ...
     (mpg123-face-cur ((t (:inherit font-lock-type-face))))
