(custom-set-variables
 ...
 '(safe-local-variable-values (quote ((python-indent . 4))))
...
(custom-set-faces
 ...
 '(flymake-errline ((((class color) (background dark)) (:background "color-52")) (((class color) (background light)) (:background "LightPink")) (t (:bold t))))
